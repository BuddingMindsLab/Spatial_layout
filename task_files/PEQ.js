...
var first_question_options = [`A mouse`, `A trackpad`, `Touch screen`, "other"];
...
var second_question = {
  type: "survey-text",
  preamble:
    "<b>2. In the card game tasks, what was your strategy when learning where the objects were located?</b>",
  data: { phase: "PEQ" },
  questions: [
    {
      prompt: "a) First card game:",
      rows: 5,
      columns: 40,
      name: "2a",
      required: true,
...
`,
      options: ["It helped me", "It distracted me", "It had no effect"],
      required: false,
      horizontal: false,
      name: "4",
    },
...
question_seven = {
  ...
  questions: [
    {
      prompt: "<b> 6. Do you have any other comments? (optional)</b>",
      rows: 5,
      columns: 40,
      name: "First card game",
      required: false,
      name: "6",
    },
  ],
