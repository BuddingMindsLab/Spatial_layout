  ...
  plugin.info = {
    ...
    parameters: {
      pages: {
        ...
        array: true,
        description:
          "Each element of the array is the html content for an image of a single page.",
      },
      audio: {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    function show_current_page() {
      ...
      html +=
        ...
        `" id="correct_card" width="100%" height="100%">`;
      ...
      if (trial.show_clickable_nav) {
        ...
        nav_html +=
          "<button disabled id='replay-button' class='jspsych-btn'" +
          "style='margin-left: 5px;'>Replay</button>";
        nav_html +=
          "<button id='pauseplay-button' class='jspsych-btn'" +
          "style='margin-left: 5px;'>Pause/Play</button>";
        nav_html +=
          "<button disabled id='jspsych-instructions-next' class='jspsych-btn'" +
        ...
        display_element
          .querySelector("#pauseplay-button")
          .addEventListener("click", function () {
